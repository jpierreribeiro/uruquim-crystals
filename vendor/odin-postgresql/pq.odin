...
/*----- [[Connection State Functions; https://www.postgresql.org/docs/16/libpq-status.html]] -----*/
	...
	// URUQUIM CRYSTALS PATCH 1 (WP74): upstream misspelled the C symbol as
	// PQparamterStatus. The declaration compiled until used, then failed to link.
...
/*----- [[Miscellaneous Functions; https://www.postgresql.org/docs/16/libpq-misc.html]] -----*/
	...
	// URUQUIM CRYSTALS PATCH 2 (WP74): libpq's runtime thread-safety probe was
	// absent from the binding. The pool refuses startup unless this returns 1.
	@(link_name="PQisthreadsafe")
	is_thread_safe :: proc() -> i32 ---
